...
class ProUser(UserMixin):
    ...
    def __init__(self, user=None):
        ...
        self.admin_users = [{
            ...
            "pris": "我的媒体库,资源搜索,探索,站点管理,订阅管理,下载管理,媒体整理,服务,插件,系统设置",
            "level": 2,
            'search': 1
        }]
...
1. 如果曾经修改: 请去 https://raw.githubusercontent.com/vanke680/nas-tools-sites/master/user.sites.bin 下载后还原
2. 如果从未修改: 请去 https://github.com/vanke680/nas-tools/issues 创建issue，并附上报错信息
----------------------------------------------------------------------------------------------------------
            """
            log.info(f"【User】\n{recovery_msg}")
            return {}, [], {}
